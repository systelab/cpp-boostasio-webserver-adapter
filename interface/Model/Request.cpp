...
Request::Request(const std::string& method, const std::string& uri,
                 ...
                 unsigned int httpVersionMajor, unsigned int httpVersionMinor,
...
unsigned int Request::getHttpVersionMajor() const { return m_httpVersionMajor; }

unsigned int Request::getHttpVersionMinor() const { return m_httpVersionMinor; }

std::string Request::getContent() const { return m_content; }

void Request::setMethod(const std::string& method) { m_method = method; }

void Request::setURI(const std::string& uri) { m_uri = uri; }
...
void Request::setContent(const std::string& content) { m_content = content; }

RequestHeaders& Request::getHeaders() { return m_headers; }

const RequestHeaders& Request::getHeaders() const { return m_headers; }

RequestQueryStrings& Request::getQueryStrings() { return m_queryStrings; }
