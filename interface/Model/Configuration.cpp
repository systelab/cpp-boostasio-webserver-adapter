...
Configuration::Configuration(const std::string& hostAddress, unsigned int port,
...
std::string Configuration::getHostAddress() const { return m_hostAddress; }

unsigned int Configuration::getPort() const { return m_port; }
