...
boost::optional<bool> RequestParserAgent::parseBuffer(
    const char* buffer, const std::size_t bufferSize, Request& parsedRequest) {
...
bool RequestParserAgent::isChar(int c) const { return c >= 0 && c <= 127; }
...
bool RequestParserAgent::isDigit(int c) const { return c >= '0' && c <= '9'; }
